...
void handleSetPowerStateOff(thread_call_param_t param0, thread_call_param_t param1) {
    darwin_iwifi *self = (darwin_iwifi *) param0;
...
IOReturn darwin_iwifi::registerWithPolicyMaker(IOService * policyMaker) {
    IOReturn ret;
...
IOReturn darwin_iwifi::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker) {
...
void darwin_iwifi::setPowerStateOff() {
...
void darwin_iwifi::setPowerStateOn() {
