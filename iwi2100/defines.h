...
#define IPW_RX_NOTIFICATION_SIZE sizeof(struct ipw2100_rx_header) + 12
#define IPW_RX_FRAME_SIZE        (unsigned int)(sizeof(struct ipw2100_rx_header) + \
                                 sizeof(struct ipw2100_rx_frame))
