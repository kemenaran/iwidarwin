...
void handleSetPowerStateOff(thread_call_param_t param0, thread_call_param_t param1) {
    darwin_iwi3945 *self = (darwin_iwi3945 *) param0;
...
IOReturn darwin_iwi3945::registerWithPolicyMaker(IOService * policyMaker) {
    IOReturn ret;
...
IOReturn darwin_iwi3945::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker) {
...
void darwin_iwi3945::setPowerStateOff() {
...
void darwin_iwi3945::setPowerStateOn() {
    _pmPowerState = kWiFiControllerPowerStateOn;
