...
static int iwl_scan_cancel(struct iwl_priv *priv, unsigned long ms)
{
	...
	if (priv->status & STATUS_SCANNING) {
		if (!(priv->status & STATUS_SCAN_ABORTING)) {
			...
			clone->queue_te(5,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_abort_scan),priv,NULL,true);
...
static int iwl_scan_initiate(struct iwl_priv *priv)
{
	...
	clone->queue_te(4,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_request_scan),priv,NULL,true);
...
static int iwl_set_mode(struct iwl_priv *priv, int mode)
{
	...
	clone->queue_td(10,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_scan_check));
...
static void iwl_radio_kill_sw(struct iwl_priv *priv, int disable_radio)
{
	...
	clone->queue_te(1,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_restart),priv,NULL,true);
	return;
}
			   ...
			   struct iwl_rx_mem_buffer *rxb)
{
	...
	{
		if (pwork==1) clone->queue_te(8,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_init_alive_start),priv,5,true);
		if (pwork==0) clone->queue_te(9,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_alive_start),priv,5,true);
	}
	else
				       ...
				       struct iwl_rx_mem_buffer *rxb)
{
	...
	clone->queue_te(3,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_scan_completed),priv,NULL,true);
				    ...
				    struct iwl_rx_mem_buffer *rxb)
{
	...
	if (((status & STATUS_RF_KILL_HW) != (priv->status & STATUS_RF_KILL_HW))
		...
		clone->queue_te(6,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_rf_kill),priv,NULL,true);
	else
...
int iwl_rx_queue_restock(struct iwl_priv *priv)
{
	...
	if (rxq->free_count <= RX_LOW_WATERMARK)
		...
		clone->queue_te(2,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_rx_replenish),priv,NULL,true);
...
void darwin_iwi4965::iwl_irq_tasklet(struct iwl_priv *priv)
{
...
//	struct iwl_priv *priv = (struct iwl_priv*)data;
	...
	clone->queue_te(13,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_irq_tasklet),priv,NULL,true);
...
static int iwl_read_ucode(struct iwl_priv *priv)
{
	...
	const char *name = "iwlwifi-4965.ucode";	
	u8 *src;
	size_t len;
...
void darwin_iwi4965::iwl_bg_init_alive_start(struct iwl_priv *priv)
{
...
void darwin_iwi4965::iwl_bg_alive_start(struct iwl_priv *priv)
{
	//struct iwl_priv *priv =
...
void darwin_iwi4965::iwl_bg_rf_kill(struct iwl_priv *priv)
{
...
void darwin_iwi4965::iwl_bg_scan_check(struct iwl_priv *priv)
{
	//struct iwl_priv *priv =
...
void darwin_iwi4965::iwl_bg_request_scan(struct iwl_priv *priv)
{
	//struct iwl_priv *priv =
	...
	clone->queue_te(10,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_scan_check),priv,IWL_SCAN_CHECK_WATCHDOG,true);
...
void darwin_iwi4965::iwl_bg_up(struct iwl_priv *priv)
{
...
void darwin_iwi4965::iwl_bg_restart(struct iwl_priv *priv)
{
...
void darwin_iwi4965::iwl_bg_rx_replenish(struct iwl_priv *priv)
{
	//struct iwl_priv *priv =
...
void darwin_iwi4965::iwl_bg_post_associate(struct iwl_priv *priv)
{
...
void darwin_iwi4965::iwl_bg_abort_scan(struct iwl_priv *priv)
{
...
void darwin_iwi4965::iwl_bg_scan_completed(struct iwl_priv *priv)
{
	//struct iwl_priv *priv =
			      ...
			      int if_id, struct ieee80211_if_conf *conf)
{
	    ...
	    !is_multicast_ether_addr(conf->bssid)) 
	{
		...
		if (priv->iw_mode == IEEE80211_IF_TYPE_AP) {
			...
			clone->queue_te(7,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_post_associate),priv,NULL,true);
...
static void d_reset_tsf(struct ieee80211_hw *hw)
{
	...
	clone->queue_td(7,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_post_associate));
...
//	init_waitqueue_head(&priv->wait_command_queue);
		clone->queue_te(0,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_up),NULL,NULL,false);
		clone->queue_te(1,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_restart),NULL,NULL,false);
		clone->queue_te(2,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_rx_replenish),NULL,NULL,false);
		clone->queue_te(3,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_scan_completed),NULL,NULL,false);
		clone->queue_te(4,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_request_scan),NULL,NULL,false);
		clone->queue_te(5,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_abort_scan),NULL,NULL,false);
		clone->queue_te(6,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_rf_kill),NULL,NULL,false);
		clone->queue_te(7,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_post_associate),NULL,NULL,false);
		clone->queue_te(8,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_init_alive_start),NULL,NULL,false);
		clone->queue_te(9,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_alive_start),NULL,NULL,false);
		clone->queue_te(10,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_scan_check),NULL,NULL,false);
		//clone->queue_te(11,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl3945_bg_reg_txpower_periodic),NULL,NULL,false);
		clone->queue_te(13,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_irq_tasklet),NULL,NULL,false);
...
void iwl_cancel_deferred_work(struct iwl_priv *priv)
{
	...
	clone->queue_td(10,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_scan_check));
	clone->queue_td(9,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_alive_start));
	clone->queue_td(7,OSMemberFunctionCast(thread_call_func_t,clone,&darwin_iwi4965::iwl_bg_post_associate));
...
int darwin_iwi4965::iwl_pci_probe()
{
	int err = 0;
	void *base;
	u32 length;
