...
void handleSetPowerStateOff(thread_call_param_t param0, thread_call_param_t param1) {
    darwin_iwi2200 *self = (darwin_iwi2200 *) param0;
...
IOReturn darwin_iwi2200::registerWithPolicyMaker(IOService * policyMaker) {
    IOReturn ret;
...
IOReturn darwin_iwi2200::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker) {
...
void darwin_iwi2200::setPowerStateOff() {
