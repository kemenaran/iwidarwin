...
#ifndef __iwi4965_h__
#define __iwi4965_h__
...
#else
	#define IWI_LOG(...) printf("iwi4965: " __VA_ARGS__)
#endif
...
class darwin_iwi4965 : public IOEthernetController //IO80211Controller
{
...
//private:	
	...
	void iwl4965_bg_txpower_work(struct iwl_priv *priv);
	void iwl4965_bg_statistics_work(struct iwl_priv *priv);
