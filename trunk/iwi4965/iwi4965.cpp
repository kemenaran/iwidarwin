...
void darwin_iwi4965::check_firstup(struct iwl_priv *priv)
{
	if (firstifup==0) 
	{
		queue_te(12,OSMemberFunctionCast(thread_call_func_t,this,&darwin_iwi4965::check_firstup),priv,1000,true);
...
void darwin_iwi4965::interruptOccurred(OSObject * owner, IOService *nub, int source)
{
	darwin_iwi4965 *self = (darwin_iwi4965 *)owner;
	iwl_isr(self->priv);
}
