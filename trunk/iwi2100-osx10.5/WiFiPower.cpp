...
void handleSetPowerStateOff(thread_call_param_t param0, thread_call_param_t param1) {
    darwin_iwi2100 *self = (darwin_iwi2100 *) param0;
...
IOReturn darwin_iwi2100::registerWithPolicyMaker(IOService * policyMaker) {
    IOReturn ret;
...
IOReturn darwin_iwi2100::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker) {
 ...
 IWI_DEBUG("power state (%d)\n", powerStateOrdinal);
    ...
    switch (powerStateOrdinal) {
        ...
        default:
            IWI_DEBUG("invalid power state (%ld)", powerStateOrdinal);
            break;
    }
...
void darwin_iwi2100::setPowerStateOff() {
...
void darwin_iwi2100::setPowerStateOn() {
    _pmPowerState = kWiFiControllerPowerStateOn;
