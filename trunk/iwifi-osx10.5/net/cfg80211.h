...
struct wiphy {
	...
	int custom_regulatory;
	int strict_regulatory;
	int disable_beacon_hints;
	...
	char fw_version[30/*ETHTOOL_BUSINFO_LEN*/];
	u32 hw_version;
...
{
	BUG_ON(!priv);
	return NULL;//container_of(priv, struct wiphy, priv);
}
...
int ieee80211_data_from_8023(struct sk_buff *skb, u8 *addr,
			     enum nl80211_iftype iftype, u8 *bssid, int qos);
