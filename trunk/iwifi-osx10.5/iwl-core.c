...
{
	int is_single = is_single_rx_stream(priv);
	int is_cam = !test_bit(STATUS_POWER_PMI, &priv->status);
 ...
 *
 */
void iwl_update_stats(struct iwl_priv *priv, int is_tx, __le16 fc, u16 len)
{
