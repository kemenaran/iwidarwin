...
const struct ieee80211_hw_mode *iwl_get_hw_mode_(struct iwl_priv *priv, int mode)
{
	int i;
...
const struct ieee80211_hw *ieee80211_alloc_hw_(size_t priv_data_len,const struct ieee80211_ops *ops)
{
