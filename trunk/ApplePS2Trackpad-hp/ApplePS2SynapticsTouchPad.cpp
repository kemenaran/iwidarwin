...
{ 
	...
	_device->installPowerControlAction( this, OSMemberFunctionCast(PS2PowerControlAction, 
             this,&ApplePS2SynapticsTouchPad::setDevicePowerState) );
                                             ...
                                             UInt32  packetSize )
{
    ...
    dispatchRelativePointerEvent(dx, dy, buttons, time);
}
