...
bool ApplePS2Keyboard::dispatchKeyboardEventWithScancode(UInt8 scanCode)
{
  ...
  if (_extendCount == 0)
  {
	...
	break;		// left alt becomes left windows`
		...
		return true;
		case 0x56: keyCode = 0x29; break;            // <
		case 0x1a: keyCode = 0xd; break;            // +
		case 0x28: keyCode = 0x1a; break;            // ¼ »
		case 0x2b: keyCode = 0x28; break;            //   barra esquerda
		case 0x29: keyCode = 0x2b; break;            
		case 0x8:
		if (keyi==true)	
		{
			if(scanCode==0x8) 
  ...
  else
  {
	...
	break;
      ...
      case 0x35: keyCode = 0xc; break;            // -
	  case 0xc: keyCode = 0x28; break;            // '
